...
urlpatterns = [
  #  path('', include('eventrr.urls')),
    ...
    path('showall/',views.showallevents,name='showallevents'),
    path('showlistevents/',views.show_list_events,name ='show_list_events'),
    path('postlistevents/',views.post_list_events,name ='post_list_events'),
